 ...
 * 流程：server 发送 MESSAGE(DeviceControl) → client 收到并调用 DeviceControlRequestHandler。
 */
...
class DeviceControlFlowTest {
    ...
    void ptzControl_shouldInvokeHandler() throws InterruptedException {
        ...
        assertThat(controlHandler.getLastCommand()).isInstanceOf(DeviceControlPtz.class);
        DeviceControlPtz ptz = (DeviceControlPtz) controlHandler.getLastCommand();
    ...
    void rebootControl_shouldInvokeHandler() throws InterruptedException {
        ...
        assertThat(controlHandler.getLastCommand()).isInstanceOf(DeviceControlTeleBoot.class);
    }
    ...
    void recordControl_shouldInvokeHandler() throws InterruptedException {
        ...
        assertThat(controlHandler.getLastCommand()).isInstanceOf(DeviceControlRecordCmd.class);
        DeviceControlRecordCmd cmd = (DeviceControlRecordCmd) controlHandler.getLastCommand();
    ...
    void guardControl_shouldInvokeHandler() throws InterruptedException {
        ...
        assertThat(controlHandler.getLastCommand()).isInstanceOf(DeviceControlGuard.class);
        DeviceControlGuard cmd = (DeviceControlGuard) controlHandler.getLastCommand();
