...
public class DeviceInfoMessageServerHandler extends MessageServerHandlerAbstract {
    ...
    public DeviceInfoMessageServerHandler(ApplicationEventPublisher publisher, ServerDeviceSupplier serverDeviceSupplier) {
    ...
    public void handForEvt(RequestEvent event) {
        ...
        publisher.publishEvent(new ServerQueryResponseEvent(this, userId, deviceInfo.getSn(), deviceInfo));
    }
