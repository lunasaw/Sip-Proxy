...
> 版本：v1.7.0 | 日期：2026-05-26 | 状态：基于代码事实生成
>
> 关联：[LISTENER-LAYERED-DESIGN.md](LISTENER-LAYERED-DESIGN.md)、[LAYERED-ARCHITECTURE.md](LAYERED-ARCHITECTURE.md)、[GBT-28181-2022.md](../protocol/2022/GBT-28181-2022.md)
>
...
| 节号 | 命令 | 状态 | 落点 | FlowTest |
|---|---|---|---|---|
| A.2.3.1.2 | 摄像机云台控制 PTZCmd | ✅ | `ControlListener.onPtz`；`<PTZCmd>` 8 字节 hex 编码遵循 §A.3.1-7（落点：`PTZInstructionBuilder` + `PTZInstructionFormat`）；server 端高层 API：`ServerCommandSender.deviceControl{PtzCmd,FI,Preset,Cruise,Scan,Auxiliary}` 6 类（v1.6.0） | [DeviceControlFlowTest#ptzControl](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceControlFlowTest.java) + [FrontEndControlFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/FrontEndControlFlowTest.java) (PTZ 1+6 用例) |
| A.2.3.1.3 | 远程启动 TeleBoot | ✅ | `ControlListener.onTeleBoot` | [DeviceControlFlowTest#rebootControl](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceControlFlowTest.java) |
| A.2.3.1.4 | 录像控制 RecordCmd | ✅ | `ControlListener.onRecord` | [DeviceControlFlowTest#recordControl](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceControlFlowTest.java) |
| A.2.3.1.5 | 报警布防/撤防 GuardCmd | ✅ | `ControlListener.onGuard` | [DeviceControlFlowTest#guardControl](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceControlFlowTest.java) |
| A.2.3.1.6 | 报警复位 AlarmCmd | ✅ | `ControlListener.onAlarmReset` | [DeviceControlFlowTest#alarmReset](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceControlFlowTest.java)（v1.6.2 新增）|
| A.2.3.1.7 | 强制关键帧 IFameCmd | ✅ | `ControlListener.onIFrame` | [IFrameDragFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/IFrameDragFlowTest.java) |
| A.2.3.1.8 | 拉框放大 DragZoomIn | ✅ | `ControlListener.onDragIn` | [IFrameDragFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/IFrameDragFlowTest.java) |
| A.2.3.1.9 | 拉框缩小 DragZoomOut | ✅ | `ControlListener.onDragOut` | [IFrameDragFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/IFrameDragFlowTest.java) |
| A.2.3.1.10 | 看守位 HomePosition | ✅ | `ControlListener.onHomePositionControl` | [HomePositionFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/HomePositionFlowTest.java) |
| A.2.3.1.11 | PTZ 精准控制 PTZPreciseCtrl | ✅ | `ControlListener.onPtzPrecise` | [PtzPositionFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/PtzPositionFlowTest.java) |
| A.2.3.1.12 | 设备软件升级 DeviceUpgrade | ✅ | `ControlListener.onDeviceUpgrade` | [DeviceUpgradeFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceUpgradeFlowTest.java) |
| A.2.3.1.13 | 存储卡格式化 FormatSDCard | ✅ | `ControlListener.onFormatSdCard` | [SdCardFlowTest#formatSDCard](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/SdCardFlowTest.java) |
| A.2.3.1.14 | 目标跟踪 TargetTrack | ✅ | `ControlListener.onTargetTrack` | [TargetTrackFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/TargetTrackFlowTest.java) |

### §A.2.3.2 设备配置命令 — 11/11 ✅（外加 1 个超出标准）

| 节号 | 命令 | 状态 | 落点 | FlowTest |
|---|---|---|---|---|
| A.2.3.2.2 | 基本参数 BasicParam | ✅ | `ConfigListener.onBasicParamConfig` | [DeviceConfigFlowTest#basicParam](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceConfigFlowTest.java)（v1.6.2 新增）|
| A.2.3.2.3 | SVAC 编码 | ✅ | `ConfigListener.onSvacEncodeConfig` | [DeviceConfigFlowTest#svacEncode](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceConfigFlowTest.java)（v1.6.2 新增）|
| A.2.3.2.4 | SVAC 解码 | ✅ | `ConfigListener.onSvacDecodeConfig` | [DeviceConfigFlowTest#svacDecode](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceConfigFlowTest.java)（v1.6.2 新增）|
| A.2.3.2.5 | 视频参数属性 | ✅ | `ConfigListener.onVideoParamAttributeConfig` | [DeviceConfigFlowTest#videoParamAttribute](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceConfigFlowTest.java)（v1.6.2 新增）|
| A.2.3.2.6 | 录像计划 | ✅ | `ConfigListener.onVideoRecordPlanConfig` | [DeviceConfigFlowTest#videoRecordPlan](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceConfigFlowTest.java)（v1.6.2 新增）|
| A.2.3.2.7 | 报警录像 | ✅ | `ConfigListener.onVideoAlarmRecordConfig` | [DeviceConfigFlowTest#videoAlarmRecord](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceConfigFlowTest.java) |
| A.2.3.2.8 | 视频画面遮挡 PictureMask | ✅ | `ConfigListener.onPictureMaskConfig` | [DeviceConfigFlowTest#pictureMask](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceConfigFlowTest.java)（v1.6.2 新增）|
| A.2.3.2.9 | 画面翻转 FrameMirror | ✅ | `ConfigListener.onFrameMirrorConfig` | [DeviceConfigFlowTest#frameMirror](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceConfigFlowTest.java)（v1.6.2 新增）|
| A.2.3.2.10 | 报警上报开关 AlarmReport | ✅ | `ConfigListener.onAlarmReportConfig` | [DeviceConfigFlowTest#alarmReport](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceConfigFlowTest.java) |
| A.2.3.2.11 | 前端 OSD | ✅ | `ConfigListener.onOsdConfig` | [DeviceConfigFlowTest#osd](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceConfigFlowTest.java) |
| A.2.3.2.12 | 图像抓拍 SnapShot | ✅ | `ConfigListener.onSnapShotConfig` | [SnapShotFlowTest#snapShotConfig](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/SnapShotFlowTest.java) |
| —（GB28181-2016 遗留） | 视频参数范围 VideoParamOpt | ✅ 超出标准 | `ConfigListener.onVideoParamOptConfig`；2022 标准只在 §A.2.6.9 应答中允许携带，下发不在 §A.2.3.2.x 序列内，保留以兼容 2016 设备 | [DeviceConfigFlowTest#videoParamOpt](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceConfigFlowTest.java)（v1.6.2 新增）|

### §A.2.4 查询命令 — 全部 ✅

| 节号 | 命令 cmdType | 状态 | 落点 | FlowTest |
|---|---|---|---|---|
| A.2.4.2 | DeviceStatus | ✅ | `QueryListener.onDeviceStatusQuery` | [DeviceQueryFlowTest#deviceStatusQuery](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceQueryFlowTest.java) |
| A.2.4.3 | Catalog | ✅ | `QueryListener.onCatalogQuery`（同时支持 SUBSCRIBE） | [DeviceQueryFlowTest#catalogQuery](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceQueryFlowTest.java) |
| A.2.4.4 | DeviceInfo | ✅ | `QueryListener.onDeviceInfoQuery` | [DeviceQueryFlowTest#deviceInfoQuery](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceQueryFlowTest.java) |
| A.2.4.5 | RecordInfo | ✅ | `QueryListener.onRecordInfoQuery`（仅核心字段，扩展过滤字段 Type/RecorderID 等未结构化暴露，业务方可在 `DeviceRecordQuery` 上拿到原始字段） | [RecordInfoFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/RecordInfoFlowTest.java)（v1.6.2 新增）|
| A.2.4.6 | Alarm（订阅） | ✅ | `QueryListener.onAlarmQuery` / `SubscribeListener.onAlarmSubscribe` | [AlarmSubscribeFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/AlarmSubscribeFlowTest.java) |
| A.2.4.7 | ConfigDownload | ✅ | `QueryListener.onConfigDownloadQuery` | ❌ 无（仅 Response 方向有 [V156ProtocolCompletionFlowTest#configDownloadResponse](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/V156ProtocolCompletionFlowTest.java)） |
| A.2.4.8 | PresetQuery | ✅ | `QueryListener.onPresetQuery` | ❌ 无（仅 Response 方向） |
| A.2.4.9 | MobilePosition | ✅ | Query：`QueryListener.onMobilePositionQuery`；Subscribe：`SubscribeListener.onMobilePositionSubscribe`（v1.5.6 起 `SubscribeMobilePositionQueryMessageHandler` 已实现，dispatcher key=Query/SUBSCRIBE_MobilePosition） | [DispatcherRegistrationTest#clientShouldRegisterMobilePositionSubscribeHandler](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DispatcherRegistrationTest.java)（仅路由保护） |
| A.2.4.10 | HomePositionQuery | ✅ | `QueryListener.onHomePositionQuery` | [HomePositionFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/HomePositionFlowTest.java) |
| A.2.4.11 | CruiseTrackListQuery | ✅ | `QueryListener.onCruiseTrackListQuery` | [CruiseTrackFlowTest#listQuery](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/CruiseTrackFlowTest.java) |
| A.2.4.12 | CruiseTrackQuery | ✅ | `QueryListener.onCruiseTrackQuery` | [CruiseTrackFlowTest#trackQuery](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/CruiseTrackFlowTest.java) |
| A.2.4.13 | PTZPosition（订阅） | ✅ | `QueryListener.onPtzPositionQuery` / `SubscribeListener.onPtzPositionSubscribe` | [PtzPositionFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/PtzPositionFlowTest.java) |
| A.2.4.14 | SDCardStatus | ✅ | `QueryListener.onSdCardStatusQuery` | [SdCardFlowTest#sdCardStatusQuery](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/SdCardFlowTest.java) |

### §A.2.5 通知命令 — 8/8 ✅（v1.5.6 全量 GREEN）

| 节号 | 命令 cmdType | 状态 | 落点 | FlowTest |
|---|---|---|---|---|
| A.2.5.2 | Keepalive（状态信息报送） | ✅ | `DeviceNotifyListener.onKeepalive`（+ 远端漂移：`DeviceLifecycleListener.onRemoteAddressChanged`） | [KeepaliveFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/KeepaliveFlowTest.java)（4 用例：上行/NAT 漂移/未注册 404/路由保护，v1.6.1 新增） |
| A.2.5.3 | Alarm | ✅ | `DeviceNotifyListener.onAlarmNotify` | [AlarmFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/AlarmFlowTest.java) |
| A.2.5.4 | MediaStatus | ✅ | `DeviceNotifyListener.onMediaStatus` | [MediaStatusFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/MediaStatusFlowTest.java)（v1.6.2 新增）|
| A.2.5.5 | Broadcast（语音广播通知） | ✅ | Client：`NotifyListener.onBroadcastNotify`；Server：`ServerCommandSender.deviceBroadcast` 出站 | [BroadcastFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/BroadcastFlowTest.java)（v1.6.2 新增）|
| A.2.5.6 | MobilePosition | ✅ | `DeviceNotifyListener.onMobilePositionNotify`（v1.5.6 起 `MobilePositionNotifyMessageHandler` 已实现，dispatcher key=Notify/MESSAGE_MobilePosition） | [V156ProtocolCompletionFlowTest#mobilePositionNotify](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/V156ProtocolCompletionFlowTest.java) |
| A.2.5.7 | UploadSnapShotFinished | ✅ | `DeviceNotifyListener.onSnapShotFinished` | [SnapShotFlowTest#uploadFinished](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/SnapShotFlowTest.java) |
| A.2.5.8 | **VideoUploadNotify**（设备实时视音频回传通知） | ✅ | `DeviceNotifyListener.onVideoUploadNotify`（v1.5.6 起 `VideoUploadNotifyMessageHandler` + `VideoUploadNotify` entity + `CmdTypeEnum.VIDEO_UPLOAD_NOTIFY` 已实现） | [V156ProtocolCompletionFlowTest#videoUploadNotify](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/V156ProtocolCompletionFlowTest.java) |
| A.2.5.9 | DeviceUpgradeResult | ✅ | `DeviceNotifyListener.onUpgradeResult` | [DeviceUpgradeFlowTest#upgradeResult](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceUpgradeFlowTest.java) |
...
| A.2.6.4 | Catalog 应答 | ✅ | `DeviceResponseListener.onCatalogResponse` | [DeviceQueryFlowTest#catalogQuery](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceQueryFlowTest.java) |
| A.2.6.5 | DeviceInfo 应答 | ✅ | `DeviceResponseListener.onDeviceInfoResponse` | [DeviceQueryFlowTest#deviceInfoQuery](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceQueryFlowTest.java) |
| A.2.6.6 | DeviceStatus 应答 | ✅ | `DeviceResponseListener.onDeviceStatusResponse` | [DeviceQueryFlowTest#deviceStatusQuery](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceQueryFlowTest.java) |
| A.2.6.7 | RecordInfo 应答 | ✅ | `DeviceResponseListener.onRecordInfoResponse` | [RecordInfoFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/RecordInfoFlowTest.java)（v1.6.2 新增）|
| A.2.6.8 | DeviceConfig 应答 | ✅ | `DeviceResponseListener.onConfigResponse`（CMD_TYPE=DeviceConfig，仅结果码） | [DeviceConfigResponseFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceConfigResponseFlowTest.java)（v1.6.2 新增）|
| A.2.6.9 | **ConfigDownload 应答** | ✅ | `DeviceResponseListener.onConfigDownloadResponse`（v1.5.6 起 `ConfigDownloadResponseMessageHandler` + `DeviceConfigDownloadResponse` entity 已实现，dispatcher key=Response/MESSAGE_ConfigDownload） | [V156ProtocolCompletionFlowTest#configDownloadResponse](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/V156ProtocolCompletionFlowTest.java) |
| A.2.6.10 | **PresetQuery 应答** | ✅ | `DeviceResponseListener.onPresetQueryResponse`（v1.5.6 起 `PresetQueryResponseMessageHandler` 已实现，dispatcher key=Response/MESSAGE_PresetQuery） | [V156ProtocolCompletionFlowTest#presetQueryResponse](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/V156ProtocolCompletionFlowTest.java) |
...
| A.2.6.12 | HomePositionQuery 应答 | ✅ | `DeviceResponseListener.onHomePositionResponse` | [HomePositionFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/HomePositionFlowTest.java) |
| A.2.6.13 | CruiseTrackListQuery 应答 | ✅ | `DeviceResponseListener.onCruiseTrackListResponse` | [CruiseTrackFlowTest#listQuery](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/CruiseTrackFlowTest.java) |
| A.2.6.14 | CruiseTrackQuery 应答 | ✅ | `DeviceResponseListener.onCruiseTrackResponse` | [CruiseTrackFlowTest#trackQuery](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/CruiseTrackFlowTest.java) |
| A.2.6.15 | PTZPosition 应答 | ✅ | `DeviceResponseListener.onPtzPositionResponse` | [PtzPositionFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/PtzPositionFlowTest.java) |
| A.2.6.16 | SDCardStatus 应答 | ✅ | `DeviceResponseListener.onSdCardStatusResponse` | [SdCardFlowTest#sdCardStatusQuery](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/SdCardFlowTest.java) |

### (B) §9.x 流程级能力（非 cmdType，但属于基础协议）

| 流程节号 | 能力 | 状态 | 落点 | FlowTest |
|---|---|---|---|---|
| §9.1 | 注册 / 注销 / 重定向 | ✅ | Client：`ClientRegister{Success,Failure,Challenge,Redirect}Event`；Server：`DeviceLifecycleListener.onDeviceRegister/onDeviceOffline/onRegisterChallenge` | [RegistrationFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/RegistrationFlowTest.java) |
| §9.2 | 实时视音频点播 | ✅ | Client：`ClientInviteEvent`；Server：`DeviceSessionListener.onInvite{Trying,Ok,Failure}` + `onAck` | [InvitePlayFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/InvitePlayFlowTest.java) |
| §9.7 / §9.8 / §9.9 | 历史检索 / 回放 / 下载（INFO + MANSRTSP） | ✅ | `ClientInfoEvent`（payload=`String` 或 `ManSrtspRequest`）；MANSRTSP PLAY/PAUSE/TEARDOWN/SCALE 已支持 | [InfoMansrtspFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/InfoMansrtspFlowTest.java)（v1.6.2 新增 3 用例：PAUSE/PLAY/Scale）|
| §9.10 | 网络校时 | ✅ | sip-common 内置 `TimeSyncService`（SIP Date 头域 + NTP 双模式），无 L1/L2 业务事件 — 详见 §3.4 | ⚠️ 间接（`RegistrationFlowTest` 注册成功路径中 `TimeSyncServiceImpl` 自动跑过 SIP 校时；无独立单元测试） |
| §9.11 | 订阅与通知（事件订阅 / 目录订阅） | ✅ | Client：`SubscribeListener` 4 方法；Server：`DeviceResponseListener.onNotifyUpdate`（目录通知） + `onSubscribeResponse` | [AlarmSubscribeFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/AlarmSubscribeFlowTest.java) + [V156ProtocolCompletionFlowTest#catalogNotifyUpdate](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/V156ProtocolCompletionFlowTest.java) |
| §9.12.1 | 语音广播 | ✅ | Client：`NotifyListener.onBroadcastNotify` + `ClientInviteEvent`（媒体流建立） | [BroadcastFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/BroadcastFlowTest.java)（v1.6.2 新增；仅 §A.2.5.5 通知通道，反向 INVITE 媒体流由 §9.2 InvitePlayFlowTest 已覆盖）|
| §9.12.2 | 语音对讲 | ✅ 复用组合 | 协议层定义为 §9.2 实时点播 + §9.12.1 语音广播的组合，无独立 cmdType；矩阵不单列，业务方监听 `ClientInviteEvent` + `NotifyListener.onBroadcastNotify` 双事件即可 | ❌ 无（依赖 §9.2 + §9.12.1 复用） |
| §9.13 | 设备软件升级 | ✅ | 下发：`ControlListener.onDeviceUpgrade`；结果：`DeviceNotifyListener.onUpgradeResult` | [DeviceUpgradeFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceUpgradeFlowTest.java) |
| §9.14 | 图像抓拍 | ✅ | 下发：`ConfigListener.onSnapShotConfig`；完成：`DeviceNotifyListener.onSnapShotFinished` | [SnapShotFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/SnapShotFlowTest.java) |
...
| §8.1 设备身份认证 | 基于口令的数字摘要（MD5）+ 数字证书（宜） | ✅ MD5 / ✅ SM3 / ⚠️ 证书 | `RegisterRequestBuilder` 完整实现 401 → Authorization Digest（MD5/SM3 + qop=auth + cnonce）；`SipDigestUtils.digestHex(algorithm,...)` 双算法切换；数字证书认证未实现，宜级要求 |
| §8.2 数据加密 | IPSec（网络层） / TLS（传输层） | ➖ 部署级 | TLS 由 SIP transport 配置（`Constant.TLS` 占位），运维侧加证书；非 sip-proxy 编码逻辑 |
| §8.3 SIP 信令认证 | 数字摘要 + Date + Note + Monitor-User-Identity 头域 | ✅ v1.7.0 | sip-common 新增 `SipHeaderConstants.{NOTE_HEADER, MONITOR_USER_IDENTITY_HEADER}` + `Sm3Digest`（GM/T 0004-2012）+ `SipDigestUtils.digestBase64`；`GbExtensionHeaderDecorator` 在 REGISTER 注入 Note + Monitor-User-Identity 链；server 端 `RegisterInfo.peerNote / peerMonitorUserIdentity` 解析；通过 `sip.common.signal-auth.{enabled,algorithm,gateway-id,user-id,user-attribute}` 配置启用 |
| §8.4 数据完整性保护 | 数字摘要 / 时间戳 / 水印 | ➖ 业务层 | 宜级要求，业务方实现 |
| §8.5 访问控制 | RBAC / ABAC + Monitor-User-Identity 跨域鉴权 | ➖ 业务层 | 同上，sip-gateway / 业务方负责；Monitor-User-Identity 头本身已由 §8.3 落地 |
| §8.6 高安全级别 | GB 35114 合规 | ⚠️ 部分 | SM3 摘要已支持（§8.3）；SM2 / SM4 双向认证待补，按需在 sip-gateway 层叠加 |
...
| 附录 A.3（前端设备控制协议） | 规范性 | 8 字节二进制 PTZ 指令编码（§A.3.1 格式 + §A.3.2-7 PTZ/FI/Preset/Cruise/Scan/Aux 6 类） | ✅ v1.6.0 全量交付 | `gb28181-common/.../instruction/PTZInstructionFormat` + `PTZInstructionBuilder` + 6 个 enum；`ServerCommandSender.deviceControl{PtzCmd,FI,Preset,Cruise,Scan,Auxiliary}` 6 类高层 API；29 单元测试 + 6 端到端 FlowTest（详见 [FRONT-END-CONTROL-PROTOCOL-PLAN.md](../plans/1.6.0/FRONT-END-CONTROL-PROTOCOL-PLAN.md)） |
...
| 附录 I | **规范性** | 协议版本标识：REGISTER 及响应头域 `X-GB-Ver` | ✅ v1.7.0 | sip-common `SipHeaderConstants.X_GB_VER_HEADER` + `GbExtensionHeaderDecorator.addXGbVer`，REGISTER 双向（请求/200 OK/401）携带；server `RegisterInfo.peerProtocolVersion` 解析；client `ClientRegisterSuccessEvent.peerProtocolVersion` 透传。默认 `3.0`，由 `sip.common.protocol-version` 配置 |
| 附录 J | **规范性** | 目录查询应答说明：5 类目录项（行政区划 / 系统 / 业务分组 / 虚拟组织 / 设备） | ✅ v1.7.0 | `DeviceItem` 21 个字段全套（IPAddress/Port/Block/Longitude/Latitude/PTZType 等）；`DeviceGbType` 引入 `BUSINESS_GROUP(215)` / `VIRTUAL_ORGANIZATION(216)` 2022 新枚举 + 旧 `VIRTUAL_ORGANIZATION_DIRECTORY` / `CENTER_SIGNAL_CONTROL_SERVER` 标 `@Deprecated` 兼容 2016；`DirectoryVersion` 枚举控制 `fromCode(int, DirectoryVersion)` 双版本解析；`sip.common.directory-version` 控制全局缺省 |
...
> **结论**：v1.7.0 起 GB/T 28181-2022 全文覆盖度按 **(A) 附录 A 命令集** **47/47 ✅**（v1.5.6 全部 GREEN）、**(B) §9 流程级** 14/14 ✅、**(C) §5/§6/§8 全局要求** 实现态分级（§6.1 ID + §6.4 SDP + §8.1 数字摘要（MD5 + SM3）+ §8.3 信令认证扩展全部 ✅）、**(D) 附录 B–O + A.3** 14 个附录中 **8 ✅**（v1.7.0 新增附录 I X-GB-Ver + 附录 J 215/216 校准）+ 3 ⚠️ + 3 ➖（媒体/网关层）+ 0 ❌。
>
> **协议命令缺口已全部清零**（v1.5.6）。**规范性硬缺口已全部清零**（v1.7.0）。剩余 ⚠️ 项均为部分实现，按需驱动：
> - 附录 K 媒体流保活（依赖媒体服务器侧 BYE 触发条件）
> - 附录 L Subject 头域结构化（sip-common 透传，sip-gateway 拆解）
> - 附录 M 多响应消息分批（业务方按 SumNum 阈值实现）
>
> 资料性 / 部分实现 / 上层职责的项目（附�� H/K/L/M/O、§5、§6.2-3、§6.5-9、§8.2/4-6）按需求驱动，本次不在交付范围。
>
> ### 端到端测试覆盖度（v1.6.1 新增 FlowTest 列）
>
> 上方各表新增的 FlowTest 列展示**协议实现 ≠ 端到端测试**的真实差距。**协议实现 ✅** 仅说明 L0/L1/L2 链路代码完整，**FlowTest** 才证明这条链路在真实 SIP 报文环境下能跑通。
>
> 当前总览（按 (A) §A.2.3.1 13 + §A.2.3.2 12（含 1 兼容）+ §A.2.4 13 + §A.2.5 8 + §A.2.6 15 + (B) §9 9 = **70 行**统计）：
>
> | 类型 | 行数 | ✅ FlowTest | ⚠️ 间接/路由 | ❌ 无 | ⚪ transport-only | 端到端覆盖率（✅/可测） |
> |---|---|---|---|---|---|---|
> | (A) §A.2.3.1 设备控制 | 13 | 13 | — | 0 | — | 100.0% |
> | (A) §A.2.3.2 设备配置（含 1 兼容）| 12 | 12 | — | 0 | — | 100.0% |
> | (A) §A.2.4 查询 | 13 | 10 | 1（MobilePosition 仅路由保护）| 2（ConfigDownload/PresetQuery 仅 Response 方向）| — | 76.9% |
> | (A) §A.2.5 通知 | 8 | 8 | — | 0 | — | 100.0% |
> | (A) §A.2.6 应答 | 15 | 12 | — | 0 | 3 | 100.0%（12/12 可测）|
> | (B) §9 流程级 | 9 | 7 | 1（§9.10 校时间接）| 1（§9.12.2 语音对讲，§9.2+§9.12.1 复用组合）| — | 77.8% |
> | **总计** | **70** | **62** | **2** | **3** | **3** | **92.5%（62/67 可测）** |
>
> v1.6.2 完成 19 个 FlowTest 缺口补齐：1 个 Control（AlarmCmd）、8 个 Config（BasicParam/SVAC*2/VideoParamAttr/VideoRecordPlan/PictureMask/FrameMirror/VideoParamOpt）、1 个 Query（RecordInfo）、2 个 Notify（MediaStatus/Broadcast）、2 个 Response（RecordInfo Query+Response 同测试覆盖、DeviceConfig Response）、3 个 §9.7-9 INFO MANSRTSP 子用例（PAUSE/PLAY/Scale）。共 **17 个新 @Test**（DeviceControlFlowTest +1、DeviceConfigFlowTest +8、RecordInfoFlowTest +2、MediaStatusFlowTest +2、BroadcastFlowTest +1、DeviceConfigResponseFlowTest +2、InfoMansrtspFlowTest +3）。
>
> 端到端覆盖率从 v1.6.1 的 68.7%（46/67）提升至 92.5%（62/67），剩余 5 项均为非协议命令缺口（MobilePosition 路由保护 / §9.10 校时间接 / §9.12.2 语音对讲组合复用 / ConfigDownload+PresetQuery 仅 Response 方向已覆盖��。
>
> **维护规则更新**（详见 §十）：增加新 cmdType 时，FlowTest 与 L0/L1/L2 同等强制，未带 FlowTest 的实现在矩阵保留 ❌ 标注且不计入 ✅ 总数。
...
| 1.6.0 | 2026-05-25 | **§A.3 前端设备控制协议完整实现 + 代码孤岛清理（破坏性升级，无兼容期）**：(1) **TDD Step 1** 新增 `gb28181-common/src/test/.../instruction/` 下 `PTZInstructionFormatTest`（11 例）+ `PTZInstructionBuilderTest`（18 例 / 6 个 `@Nested` 子节，对照 GBT §A.3 表 A.5/A.7/A.8/A.9/A.10/A.11 官方举例），共 **29 单元测试 GREEN**；(2) **TDD Step 2** `ServerCommandSender` 新增 6 类高层 API：`deviceControlPtzCmd(PTZControlEnum)` / `deviceControlFI` / `deviceControlPreset` / `deviceControlCruise` / `deviceControlCruiseSpeedOrTime` / `deviceControlScan` / `deviceControlScanSpeed` / `deviceControlAuxiliary`；(3) 新增 `gb28181-test/.../FrontEndControlFlowTest`（6 端到端 FlowTest，验证 server → client 完整 hex 编码 + `PTZInstructionFormat.fromHexString().isValid()` 校验）；(4) **Stage 3 死代码清理**：删除 `PtzUtils.java` / `PtzCmdEnum.java`（老 50 行重复实现，零生产引用）+ `PTZInstructionDemo.java` / `PTZInstructionCoreValidation.java` / `PTZInstructionCompleteValidation.java`（4 个 `main()` 验证类，违反 JUnit 规范）+ `PTZInstructionExamples.java`（401 行示例污染主源码）+ `PTZInstructionCrypto.java`（GBT 协议未要求加密，过度设计）+ `PTZInstructionManager.java` / `PTZInstructionSerializer.java`（零引用 YAGNI 清理）共 **9 个文件 ~2138 LOC**；(5) 迁移破坏性 callers：`gb28181-test/.../PtzRequest` 字段类型 `PtzCmdEnum` → `PTZControlEnum`，`DeviceControlFlowTest.ptzControl_shouldInvokeHandler` 调用迁移；(6) §0(D) 附录 B–O 表新增 「附录 A.3 前端设备控制协议」一行（标 ✅），§A.2.3.1.2 PTZCmd 落点追加 6 类高层 API 引用；(7) 全量回归 `gb28181-test` 59/59 GREEN（53 既有 + 6 新 FrontEndControlFlow），`mvn install` 全模块 BUILD SUCCESS；(8) 净结果：3469 → 1331 LOC（-2138），覆盖率从 1/7 子节升至 7/7，编码源从两套并存收敛为唯一 `PTZInstructionBuilder`，所有 hex 输出经 `PTZInstructionFormat.isValid()` 闸门保护 |
| 1.6.1 | 2026-05-25 | **TDD 补 §A.2.5.2 心跳端到端流测 + 矩阵 FlowTest 列**：(1) **TDD Red Step 1** 新增 [KeepaliveFlowTest.java](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/KeepaliveFlowTest.java) 4 用例：上行 `keepaliveNotify_shouldTriggerNotifyEvent` / NAT 漂移 `keepaliveNotify_shouldTriggerRemoteAddressChanged` / 未注册 404 `keepaliveFromUnregisteredDevice_shouldNotTriggerListener` / 路由保护 `clientShouldRegisterKeepaliveControlHandler`，覆盖 §3.4 `KeepaliveNotifyMessageHandler:53-57` 的 device==null 404 分支与 :62-63 `remoteAddressChanged` 路径；(2) 配套 `TestServerEventHandler` 新增 `lastRemoteAddressInfo` 字段 + `lifecycleLatch` + `resetLifecycle(latch)` 方法 + `onRemoteAddressChanged` override（与既有 notify latch 解耦避免互相 countDown 干扰）；(3) **TDD Green** `gb28181-test` KeepaliveFlowTest 4/4 GREEN；(4) **矩阵补 FlowTest 列**：§0(A) §A.2.3.1 / §A.2.3.2 / §A.2.4 / §A.2.5 / §A.2.6 + §0(B) §9 流程级 共 6 个表新增 FlowTest 列（每行对应 `[文件名](路径)` markdown 链接），结论段新增「端到端测试覆盖度」总览（70 行 = 47 ✅ + 2 ⚠️ + 19 ❌ + 3 ⚪，**端到端覆盖率 68.7%（46/67 可测）**），暴露 §A.2.3.2 设备配置（4/12）+ §A.2.6 RecordInfo/DeviceConfig 应答 + §9.7-9 INFO MANSRTSP / §9.12.1 Broadcast / §9.12.2 语音对讲等真实缺口；(5) 修正前 v1.6.0 起的隐性误导："附录 A 47/47 ✅" 仅指协议**实现**完整，**端到端测试**实际仅 64–69%，差出去一个数量级；(6) **§十 维护承诺新增第 7 条**：增加新 cmdType 时 FlowTest 与 L0/L1/L2 同等强制，未带 FlowTest 的实现在矩阵保留 ❌ 标注且不计入 ✅ 总数 |
| 1.6.2 | 2026-05-26 | **TDD 全量补齐 19 个 FlowTest 缺口 — 端到端覆盖率 68.7% → 92.5%**：(1) **TDD Red** v1.6.1 矩阵结论暴露的 19 个 ❌ 行（§A.2.3.1.6 AlarmCmd / §A.2.3.2 设备配置 8 缺 / §A.2.4.5 RecordInfo Query / §A.2.5.4 MediaStatus / §A.2.5.5 Broadcast / §A.2.6.7 RecordInfo Response / §A.2.6.8 DeviceConfig Response / §9.7-9 INFO MANSRTSP / §9.12.1 Broadcast）；(2) **基础设施扩展**：`ServerCommandSender` 新增 8 个 config 高层 API（`deviceConfigSvacEncode/Decode` / `deviceConfigVideoParamAttribute` / `deviceConfigVideoParamOpt` / `deviceConfigVideoRecordPlan` / `deviceConfigPictureMask` / `deviceConfigFrameMirror`）+ `deviceControlAlarm` 三参重载（修复 spec 缺失的 `<AlarmCmd>` 字段）；`TestClientImpl` 新��� 8 个 `lastXxxConfig` getter + 8 个 listener override；`TestServerEventHandler` 新增 `lastMediaStatus` / `lastConfigResponse` / `lastDeviceInfoRequestContent` / `lastDeviceInfoErrorReason` getter + 4 个 listener override；新建 `TestInfoEventCapture` bean 订阅 L1 `ClientInfoEvent`；(3) **TDD Green 17 个新 @Test**：[DeviceControlFlowTest#alarmReset](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceControlFlowTest.java) +1，[DeviceConfigFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceConfigFlowTest.java) +8（basicParam/svacEncode/svacDecode/videoParamAttribute/videoParamOpt/videoRecordPlan/pictureMask/frameMirror），[RecordInfoFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/RecordInfoFlowTest.java) 新增 +2，[MediaStatusFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/MediaStatusFlowTest.java) 新增 +2，[BroadcastFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/BroadcastFlowTest.java) 新增 +1，[DeviceConfigResponseFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/DeviceConfigResponseFlowTest.java) 新增 +2，[InfoMansrtspFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/InfoMansrtspFlowTest.java) 新增 +3（PAUSE/PLAY/Scale）；(4) **InfoRequestProcessor 设计改进**：调换 `publisher.publishEvent(...)` 与 `ResponseCmd.sendResponse(Response.OK, ...)` 顺序——业务事件 fan-out 是本地操作，不应被网络层 200 OK 失败遮蔽（测试环境 self-loop 共享端口时 JAIN-SIP transaction 状态混乱；生产环境同样受益于此防御性写法）；响应失败降级为 WARN 日志而非 ERROR；(5) `gb28181-test` 全量回归 **85/85 GREEN**（v1.6.1 的 64 个 + v1.6.2 新增 17 + 4 个内部修复使既有 GREEN 保持）；(6) §0 总览端到端覆盖率从 v1.6.1 的 68.7%（46/67 可测）跃升至 **92.5%（62/67）**；(7) 矩阵 §0(A) §A.2.3.1 / §A.2.3.2 / §A.2.4 / §A.2.5 / §A.2.6 + §0(B) §9 流程级 6 个表的 FlowTest 列将 17 行 ❌ 升 ✅；剩余 5 项均为非协议命令缺口（MobilePosition 仅路由保护 / §9.10 校时间接 / §9.12.2 语音对讲属 §9.2+§9.12.1 复用组合 / ConfigDownload+PresetQuery 仅 Response 方向已在 V156ProtocolCompletionFlowTest 覆盖） |

| 1.7.0 | 2026-05-26 | **GB/T 28181-2022 三个规范性硬缺口全部清零**（附录 I X-GB-Ver / §8.3 信令认证扩展 / 附录 J 215/216 校准）：(1) **附录 I**：sip-common 新增 [SipHeaderConstants](../../sip-common/src/main/java/io/github/lunasaw/sip/common/constant/SipHeaderConstants.java) 集中头域常量（X_GB_VER_HEADER + Note + Monitor-User-Identity + 表 I.1 4 档版本）；新增 [GbExtensionHeaderDecorator](../../sip-common/src/main/java/io/github/lunasaw/sip/common/transmit/request/GbExtensionHeaderDecorator.java) 静态门面（`addXGbVer` / `addNoteHeader` / `addMonitorUserIdentity`）；`RegisterRequestBuilder.customizeRequest` 调用 decorator 注入扩展头；server `ServerRegisterRequestProcessor.{getRegisterOkHeaderList, sendAuthChallenge, buildRegisterInfo}` 双向带头 + 解析；client `ClientRegisterResponseProcessor.handleRegisterSuccess` 解析对端 X-GB-Ver；`ClientRegisterSuccessEvent.peerProtocolVersion` 透传到业务层��`RegisterInfo.peerProtocolVersion` 暴露到 server lifecycle；默认 `3.0`，由 `sip.common.protocol-version` 配置。(2) **§8.3**：sip-common 新增 [Sm3Digest](../../sip-common/src/main/java/io/github/lunasaw/sip/common/utils/Sm3Digest.java)（GM/T 0004-2012 §5 直接实现，无 BouncyCastle 依赖，~150 LOC）+ [SipDigestUtils](../../sip-common/src/main/java/io/github/lunasaw/sip/common/utils/SipDigestUtils.java) 双算法门面（MD5 / SM3 自动切换 + BASE64）；`RegisterRequestBuilder.buildRegisterRequestWithAuth` 摘要按 WWW-Authenticate `algorithm` 参数选择，HA1/HA2/RESPONSE 全链路支持 SM3；server `DigestServerAuthenticationHelper` 重写为按 `AuthorizationHeader.algorithm` 解析摘要算法（保留 MD5 默认）；`RegisterInfo.{peerNote, peerMonitorUserIdentity}` ��析对端摘要扩展；`SipCommonProperties.SignalAuth` 配置 `enabled/algorithm/gateway-id/user-id/user-attribute` 启用。(3) **附录 J**：[DeviceGbType](../../gb28181-common/src/main/java/io/github/lunasaw/gb28181/common/entity/enums/DeviceGbType.java) 引入 `BUSINESS_GROUP(215)` / `VIRTUAL_ORGANIZATION(216)` 2022 标准命名 + 旧 `VIRTUAL_ORGANIZATION_DIRECTORY` / `CENTER_SIGNAL_CONTROL_SERVER` 标 `@Deprecated`；新增 [DirectoryVersion](../../gb28181-common/src/main/java/io/github/lunasaw/gb28181/common/entity/enums/DirectoryVersion.java) 枚举 + `fromCode(int, DirectoryVersion)` 双版本解析路径；缺省版本 V_2022，`sip.common.directory-version` 控制全局；`DeviceItem.getInstanceExample` 同步两套类型常量分支。(4) **测试覆盖**：sip-common 新增 [Sm3DigestTest](../../sip-common/src/test/java/io/github/lunasaw/sip/common/utils/Sm3DigestTest.java)（GM/T 0004-2012 §A.1/§A.2 标准向量 5 例）+ [SipDigestUtilsTest](../../sip-common/src/test/java/io/github/lunasaw/sip/common/utils/SipDigestUtilsTest.java)（双算法 + BASE64 + 大小写不敏感 6 例）；gb28181-common 新增 [DirectoryVersionCompatTest](../../gb28181-common/src/test/java/io/github/lunasaw/gb28181/common/entity/enums/DirectoryVersionCompatTest.java)（2016/2022 双向解析 7 例）；gb28181-test 新增 [XGbVerHeaderFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/XGbVerHeaderFlowTest.java) + [SignalAuthHeaderFlowTest](../../gb28181-test/src/test/java/io/github/lunasaw/gbproxy/test/SignalAuthHeaderFlowTest.java) 双向端到端校验；`TestRegisterSuccessProbe` 新 bean 监听 `ClientRegisterSuccessEvent`；`TestServerEventHandler` 新增 `lastRegisterInfo` + `onDeviceRegister` override。(5) **全量回归**：87/87 GREEN（v1.6.2 的 85 + 2 新 FlowTest），sip-common 协议纯净性脚本 ✅。(6) **矩阵更新**：(C) §8.1 升 ✅ MD5/✅ SM3、§8.3 升 ✅、§8.6 升 ⚠️ 部分；(D) 附录 I/J 双 ✅；§十一 P1 缺口表全部标 ✅ |
...
- **新增 cmdType 必须同时新增 FlowTest**（v1.6.1 起强制）：协议矩阵每行的 FlowTest 列与 L0/L1/L2 列同等地位，仅有协议解析、listener 接口、adapter 分支三件套**不算实现完成**；未带端到端 FlowTest 的命令在矩阵保留 ❌ 标注且不计入 ✅ 总数。维护流程：(1) 写完 handler 与 listener 后，在 `gb28181-test` 加 FlowTest，断言「sender → SIP transport → handler → adapter → listener payload」整条链路；(2) 立即在矩阵 §0(A)/(B) 对应行的 FlowTest 列填 `[FlowTest 类名](相对路径)` markdown 链接；(3) §0 结论段「端到端测试覆盖度」总览刷新行数与覆盖率。这条规则源于 v1.6.1 发现：「附录 A 命令集 47/47 ✅」此前被误解为「全部已 e2e 测试」，但实际端到端覆盖仅 68.7%，差出一个数量级。
...
| 附录 I X-GB-Ver | SIP 头扩展 | 0（仅常量） | 5（builder + 双向 processor + 2 个 device dto + test） | ~200 | 加性，老对端不携带时静默忽略 | P1 | ✅ v1.7.0 |
| §8.3 Note + Monitor-User-Identity + SM3 | 安全扩展 | 2（Sm3Digest + SipDigestUtils） | 5（builder + 常量 + 配置 + decorator + 测试） | ~350 | 加性；零外部依赖（SM3 自实现，无 BouncyCastle） | P2 | ✅ v1.7.0 |
| 附录 J §J.f-g 215/216 校准 | 类型枚举 | 1（DirectoryVersion） | 4（enum + DeviceItem 解析 + 配置 + 测试） | ~120 | **加性兼容**：旧枚举常量保留 `@Deprecated`；2022 默认行为切换到 `BUSINESS_GROUP/VIRTUAL_ORGANIZATION` | P2 | ✅ v1.7.0 |
